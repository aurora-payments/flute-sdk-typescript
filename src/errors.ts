...
/**
 * Shape of the JSON body the Arise/Flute API returns on errors.
 * Mirrors the contract documented in the OpenAPI spec
 * (`AspNet.Swagger.Examples.*ExceptionExample`).
 *
 * @public
 */
