...
[ARISE-1845](https://rwaapps.atlassian.net/browse/ARISE-1845)). Patterns
that land here become the contract every other language SDK follows, so
...
`commit-msg` hook validates it. Examples:
...
covered by SemVer. Internal modules (`src/internal/`) may break between
minor versions. Don't import from internal paths in tests you intend to
ship as examples.
