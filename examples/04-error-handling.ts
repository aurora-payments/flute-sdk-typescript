 ...
 *
 * Maps to PRD §FR-5 (typed exception hierarchy) and the `error handling`
 * recipe expected by ISVs. Triggers each subclass deliberately so the
 * pattern is easy to copy.
 *
 * Run with:
 *
